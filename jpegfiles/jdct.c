 ...
 *
 * This file has been modified for use with the TSEA02 course
 *
...
/* The original version scaled the results of the rowwise DCT left two
 * steps in order to get some extra precision for the columnwise DCT
 * However, in the TSEA02 course we do not do this in order to keep
 * the hardware accelerator as simple as possible while retaining the
 * same results as the software version.
 */
 
#define CONST_BITS  13

/* Precalculated constans */
...
#define FIX_C6           (  4433)        /* sqrt(2) * (c6) */
#define FIX_S6           (  10703)       /* sqrt(2) * (s6) */
#else
